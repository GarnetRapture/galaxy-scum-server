...
export const galaxyRules: GalaxyRule[] = [
  ...
  { id: "rule-road", title: { ko: "건축물 도로 침범 금지", en: "No base structures may intrude onto roads." }, detail: { ko: "도로 침범은 재건축 요청 대상이다.", en: "Road intrusion can trigger a rebuild request." }, severity: "important" },
  { id: "rule-loot-area", title: { ko: "파밍지 점거 금지", en: "Do not occupy or monopolize loot areas." }, severity: "important" },
  { id: "rule-base-distance", title: { ko: "파밍지 인근 베이스 건설은 거리 확인 후 진행", en: "Build away from loot zones unless the distance is confirmed." }, detail: { ko: "애매한 위치나 작은 파밍지는 디스코드 문의 후 진행한다.", en: "Use Discord support before building near ambiguous or small loot locations." }, severity: "important" },
  ...
  { id: "rule-support-demand", title: { ko: "무리한 지원 요구 금지", en: "Do not make excessive support requests." }, detail: { ko: "서버 규칙은 평등과 공정성을 기준으로 적용된다.", en: "Server rules are applied around equality and fairness." }, severity: "important" },
  ...
  { id: "rule-pvp-recruit", title: { ko: "PVE 유저에게 PVP 권유 금지", en: "Do not recruit PvE players into PvP." }, detail: { ko: "PVP 예정 유저끼리 연결은 디스코드 문의로 요청할 수 있다.", en: "Players already intending to move to PvP can use Discord support for matching." }, severity: "critical" },
...
export const beginnerRouteSteps: BeginnerRouteStep[] = [
  ...
  {
    id: "base",
    title: { ko: "베이스 후보지 확인", en: "Base location check" },
    timeframe: { ko: "1일차", en: "Day 1" },
    objectives: [
      { ko: "도로와 파밍지에서 충분히 떨어진 위치만 후보로 둔다.", en: "Only consider sites away from roads and loot zones." },
      { ko: "애매한 파밍지 근처는 디스코드 문의 전 건축하지 않는다.", en: "Do not build near ambiguous loot spots before Discord support confirms the rule fit." },
...
export const versionKnowledge: VersionKnowledge = {
  ...
  highlights: [
    ...
    },
    {
      ...
      points: [
        { ko: "동물 활성화, 전체 밀도, 비가상 동물 최대 수, 종별 표현 배율을 조정할 수 있다.", en: "Server settings can control animal enablement, density, non-virtual caps, and species representation multipliers." },
